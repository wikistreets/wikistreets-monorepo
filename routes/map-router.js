...
const mapRouter = ({ config }) => {
  ...
  router.get('/map/upgrade', async (req, res) => {
    const data = {
      ...
      publicId: '1f90b6e8-fe87-476f-ba5d-66f91a5a7108',
      features: [
        {
          type: 'Feature',
          geometry: {
            type: 'Point',
            coordinates: ['-0.0699302767596577', '51.5549278562206'],
          },
          user: '5f78faa4a031de2e33c69578',
          properties: {
            title: 'RIP arlo’s balls',
            address:
              '88 Farleigh Road, Stoke Newington, London, N16 7TZ, United Kingdom',
            photos: [
              {
                filename: '02c0ca97-dfde-4ebf-a036-9bf3dc0762b5.jpg',
                mimetype: 'image/jpeg',
                encoding: '7bit',
                size: 132805,
              },
        ...
        },
        {
          ...
          geometry: {
            type: 'Point',
            coordinates: ['-0.06403207129326073', '51.553927224472105'],
          },
          user: '5f78faa4a031de2e33c69578',
          properties: {
            title: 'Fresh kill',
            address:
              'Kellerman&#x27;s Vacation Resort, London, England E5 8QH, United Kingdom',
            photos: [
              {
                filename: 'e175b38e-0609-4dfa-975d-04eebd3cc607.jpg',
                mimetype: 'image/jpeg',
                encoding: '7bit',
                size: 69732,
              },
        ...
        },
        {
          ...
          geometry: {
            type: 'Point',
            coordinates: ['0.5802154541015626', '51.65722279808633'],
          },
          user: '5f78faa4a031de2e33c69578',
          properties: {
            title: 'Cool place for a walk',
            address:
              'Creephedge Lane, Rettendon, Chelmsford, CM3 8RD, United Kingdom',
            photos: [
              {
                filename: '983a66dc-9f72-42b9-a356-d7b8dfbe00c5.jpg',
                mimetype: 'image/jpeg',
                encoding: '7bit',
                size: 1684591,
              },
        ...
        },
        {
          ...
          geometry: {
            type: 'Point',
            coordinates: ['1.5847778320312502', '51.704906406014544'],
          },
          user: '5f78faa4a031de2e33c69578',
          properties: {
            title: 'Awesome sex',
            ...
            photos: [
              {
                filename: '0ffd5895-4560-4df8-8e90-3e6fcec1d5fa.jpg',
                mimetype: 'image/jpeg',
                encoding: '7bit',
                size: 117390,
              },
      ...
      contributors: ['5f78faa4a031de2e33c69578'],
      forks: [],
